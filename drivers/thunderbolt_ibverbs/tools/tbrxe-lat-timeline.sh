#!/usr/bin/env bash
# tbrxe-lat-timeline.sh - stage visibility for the tbrxe/tbframe data path.
#
...
# tbrxe, so a plain bpftrace kprobe cannot attach ("symbol is not unique"),
...
# to tbframe/tbrxe stay plain bpftrace kprobes.
#
...
EVENTS="
tbvlt_post:tbrxe:rxe_post_send:POST
tbvlt_send:tbrxe:rxe_sender:SEND
tbvlt_recv:tbrxe:rxe_receiver:RECV
tbvlt_cq:tbrxe:rxe_cq_post:CQ
tbvlt_retx:tbrxe:retransmit_timer:RETX
tbvlt_rnrt:tbrxe:rnr_nak_timer:RNRT
"
